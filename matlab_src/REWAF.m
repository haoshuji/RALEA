function [ Regret,NumReq, run_time, regrets,regrets_idx,NUMs,TMs]=REWAF(W, data, options, ID)
%% REWAF:  Random Exponentially Weighted Forecaster
%%-------------------------------------------------------------------------
%%
%%
%%-------------------------------------------------------------------------
